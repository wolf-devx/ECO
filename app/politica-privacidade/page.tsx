  ...
  return (
    <LegalLayout title="Política de Privacidade" lastUpdated="12 de junho de 2025">
      ...
      <LegalSection id="dados-coletados" title="2. Dados Coletados">
        ...
        <ul>
          <li><strong>Dados pessoais fornecidos:</strong> nome completo, CPF, e-mail, telefone, endereço, senha, foto de perfil e dados inseridos em denúncias.</li>
          <li><strong>Dados técnicos:</strong> endereço IP, localização aproximada, tipo de navegador, sistema operacional, data e hora de acesso.</li>
          <li><strong>Dados de uso:</strong> páginas acessadas, tempo de permanência, cliques e interações com jogos educativos.</li>
          <li><strong>Dados sensíveis:</strong> imagens, áudios e vídeos que possam conter dados biométricos, étnicos ou de terceiros (caso você os envie).</li>
        </ul>
        <p>
